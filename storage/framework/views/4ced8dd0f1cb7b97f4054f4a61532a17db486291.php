    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <div class="input-group date">
                        <input type="text" class="form-control datetimepicker-input" value="<?php echo e(timePickerFormat(now()->addHours(1))); ?>" name="start_date"
                            data-date-format="<?php echo e(strtoupper(get_option('date_picker_format'))); ?> hh:mm A" data-date-start-date="moment()" required>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <div class="input-group date">
                        <input type="text" class="form-control datetimepicker-input" value="<?php echo e(timePickerFormat(now()->addDays(1))); ?>" name="end_date"
                            data-date-format="<?php echo e(strtoupper(get_option('date_picker_format'))); ?> hh:mm A" data-date-start-date="moment()" required>
                        <div class="input-group-addon">
                            <?php echo e(svg_image('solid/calendar-alt', 'text-muted')); ?>
                        </div>
...
<?php echo $__env->make('stacks.css.colorpicker', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopPush(); ?>
...
<?php echo $__env->make('stacks.js.colorpicker', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->yieldPushContent('pagescript'); ?><?php /**PATH C:\xampp2\htdocs\NETIC360APP\Modules\Calendar\Providers/../Resources/views/modal/create.blade.php ENDPATH**/ ?>