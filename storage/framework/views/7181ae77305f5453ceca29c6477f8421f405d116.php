  ...
  <div class="col-lg-3 col-md-6">
    <div class="thumbnail">
      ...
      <div class="caption text-center">
        <h6>
          <a class="text-indigo-600" href="<?php echo e(route('contacts.view', $contact->user_id)); ?>">
        ...
        <p class="mt-3">
          ...
          <a href="<?php echo e($contact->twitter); ?>" target="_blank"
            class="btn btn-rounded btn-twitter btn-icon"><?php echo e(svg_image('brands/twitter')); ?></a>
          <?php endif; ?>
          ...
          <?php endif; ?>
          <a href="<?php echo e(route('contacts.email', $contact->user_id)); ?>" class="btn btn-rounded btn-dracula btn-icon"
            data-toggle="ajaxModal" data-rel="tooltip" title="<?php echo trans('app.'.'send_email'); ?>"><?php echo e(svg_image('solid/paper-plane')); ?></a>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\xampp2\htdocs\NETIC360APP\Modules\Contacts\Providers/../Resources/views/_ajax/_contacts.blade.php ENDPATH**/ ?>