<header class="bg-<?php echo e(get_option('top_bar_color')); ?> header navbar  navbar-fixed-top-xs ">
    <div class="container-fluid">
            ...
            <li class="">
                ...
                <div class="m-t m-l-lg">
                    <?php if(\Auth::user()->tasksUpcoming() > 0): ?>
                        <a href="<?php echo e(route('tasks.upcoming')); ?>" class="" data-toggle="tooltip"
                            title="<?php echo trans('app.'.'tasks'); ?>" data-placement="bottom">
                            <?php echo e(svg_image('solid/tasks')); ?>
                            <span
                                class="bg-red-500 badge badge-sm up m-l-n-sm display-inline"><?php echo e(\Auth::user()->tasksUpcoming()); ?></span>
                        </a>
                    <?php endif; ?>
                    <?php if(\Auth::user()->todoToday() > 0): ?>
                        <a href="<?php echo e(route('calendar.todos')); ?>" class="" data-toggle="tooltip"
                            title="<?php echo trans('app.'.'todo'); ?>" data-placement="bottom">
                            <?php echo e(svg_image('regular/check-circle')); ?>
                            <span
                                class="bg-red-500 badge badge-sm up m-l-n-sm display-inline"><?php echo e(\Auth::user()->todoToday()); ?></span>
                        </a>
                    <?php endif; ?>

                    <?php if(Auth::user()->newchats->count()): ?>
                        <a href="<?php echo e(route('leads.index')); ?>" class="m-l" data-toggle="tooltip" title="WhatsApp"
                            data-placement="bottom">
                            <?php echo e(svg_image('solid/comment-alt', 'fa-lg text-success')); ?>
                            <span
                                class="badge badge-sm up bg-dracula m-l-n-sm display-inline"><?php echo e(Auth::user()->newchats->count()); ?></span>
                        </a>
                    <?php endif; ?>

                    <a href="<?php echo e(route('calendar.appointments')); ?>" class="m-l" data-toggle="tooltip"
                        title="<?php echo trans('app.'.'appointments'); ?> " data-placement="bottom">
                    ...
                    <div class="btn-group dropdown ">
                        ...
                        <ul class="dropdown-menu">
                            <?php $__currentLoopData = languages(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="">
                                    <a href="<?php echo e(route('setLanguage', ['locale' => $lang['code']])); ?>"
        ...
        <ul class="nav navbar-nav navbar-right hidden-xs nav-user">
            ...
            <?php if(count(runningTimers()) > 0): ?>
                <li class="">
                    <a href="<?php echo e(route('timetracking.timers')); ?>" title="<?php echo trans('app.'.'timers'); ?>" data-toggle="ajaxModal"
                        data-toggle="tooltip" data-placement="bottom">
                        <i class="fas fa-sync-alt fa-spin fa-lg <?php echo e(themeText()); ?>"></i>
                        <span
                            class="bg-blue-400 badge badge-sm up m-l-n-sm display-inline"><?php echo e(count(runningTimers())); ?></span>
                    </a>
                </li>
            <?php endif; ?>
            ...
            <li>
                <form action="<?php echo e(route('search.app')); ?>" method="POST" role="search" class="">
                    <?php echo csrf_field(); ?>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu animated fadeInRight">
                    ...
                    <?php if(config('system.remote_support') && isAdmin()): ?>
                        ...
                        <li><a href="<?php echo e(route('tell.friend')); ?>" data-toggle="ajaxModal"><?php echo trans('app.'.'tell_friend'); ?></a>
                        </li>
                    <?php endif; ?>
                    <li class="divider"></li>
...
<?php /**PATH C:\xampp2\htdocs\NETIC360APP\resources\views/partial/top_header.blade.php ENDPATH**/ ?>