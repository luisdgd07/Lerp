...
<script type="text/javascript">
    $(document).ready(function () {
            $('#icon').iconpicker({hideOnSelect: true, placement: 'bottomLeft', icons:[
                {
                    title: "fas fa-ad",
                    searchTerms: []
                }, {
...
</script><?php /**PATH C:\xampp2\htdocs\NETIC360APP\resources\views/stacks/js/iconpicker.blade.php ENDPATH**/ ?>