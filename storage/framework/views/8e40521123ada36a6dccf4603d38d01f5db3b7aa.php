                    ...
                    <tr class="sortable" data-module="<?php echo e($adm->module); ?>" data-access="1">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <button data-toggle="dropdown" data-selected="<?php echo e($adm->icon); ?>" class="menu-icon icp icp-dd btn btn-default dropdown-toggle" type="button"
                                    aria-expanded="false" data-role="1" data-href="<?php echo e(route('menu.icon', ['module' => $adm->module])); ?>">
                        ...
                        <td>
                            <a data-toggle="tooltip" title="<?php echo trans('app.'.'toggle'); ?>" class="menu-view-toggle btn <?php echo e($adm->visible == 1 ? 'btn-info' : 'btn-default'); ?>" href="#"
                                data-role="1" data-href="<?php echo e(route('menu.visible', ['module' => $adm->module])); ?>">
...
<?php echo $__env->make('stacks.js.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('stacks.js.sortable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp2\htdocs\NETIC360APP\Modules\Settings\Providers/../Resources/views/sections/menu.blade.php ENDPATH**/ ?>