...
<head>
    ...
    <?php echo $__env->make('partial.g-analytics', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    <meta charset="utf-8" />
...
$ext = substr($favicon, -4);?>
    ...
    <title><?php echo e(get_option('company_name')); ?> | <?php echo e($page); ?></title>
    ...
    <?php echo $__env->make('partial.drift', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    <?php if(config('system.crisp_enabled')): ?>
    <?php echo $__env->make('partial.crisp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    <?php if(config('system.enable_onesignal')): ?>
    <?php echo $__env->make('partial.onesignal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    <?php if(config('system.enable_tawk')): ?>
    <?php echo $__env->make('partial.tawk', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    <?php if(config('system.enable_purechat')): ?>
    <?php echo $__env->make('partial.purechat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    <?php echo $__env->yieldPushContent('pagestyle'); ?>
    <link rel="stylesheet" href="<?php echo e(mix('css/app.css')); ?>" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(mix('css/tailwind.css')); ?>" type="text/css" />
    ...
    <?php echo $__env->make('partial.custom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<body class="antialiased text-gray-800">
    ...
    <section class="vbox" id="app">
        ...
        <?php echo $__env->make('partial.top_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <section class="">
            <section class="hbox stretch">
                <?php echo $__env->make('partial.main_menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php echo $__env->yieldContent('content'); ?>
                <?php echo $__env->make('partial.notifier', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </section>
        </section>
    </section>
    ...
    <?php echo $__env->make('partial.pusher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#clear-alerts').click(function () {
                axios.get('<?php echo e(route('users.notifications.clear')); ?>')
        ...
        function insertCannedMessage(d) {
            if(d > 0){
                ...
                .then(function (response) {
                var commentArea = $('#<?php echo e(get_option('htmleditor')); ?>');
...
</html><?php /**PATH C:\xampp2\htdocs\NETIC360APP\resources\views/layouts/app.blade.php ENDPATH**/ ?>