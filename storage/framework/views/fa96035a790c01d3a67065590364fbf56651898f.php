<ul class="list-group no-radius m-b-none m-t-n-xxs list-group-lg no-border list">
    ...
    <li class="list-group-item p-lr">
        ...
        <a href="<?php echo e(route('users.view', ['user' => $inbox->withUser->id])); ?>" class="thumb-sm pull-left m-r-sm">
...
</ul><?php /**PATH C:\xampp2\htdocs\NETIC360APP\Modules\Messages\Providers/../Resources/views/threads.blade.php ENDPATH**/ ?>