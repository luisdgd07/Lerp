...
<?php echo $__env->renderComponent(); ?>
    ...
    <?php $__env->slot('footer'); ?>
        <?php $__env->startComponent('mail::footer'); ?>
            © <?php echo e(date('Y')); ?> <?php echo e(get_option('company_name')); ?>. <?php echo app('translator')->get('All rights reserved.'); ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH C:\xampp2\htdocs\NETIC360APP\resources\views/vendor/mail/text/message.blade.php ENDPATH**/ ?>