<div class="row">
	<div class="col-sm-4">
		<section class="panel panel-info">
			<div class="panel-body">
				<div class="clear text-sm">
					<span class="text-gray-700"><?php echo trans('app.'.'total_sales'); ?> </span>
		...
		<section class="panel panel-info">
			<div class="panel-body">
				<div class="clear text-sm">
					<span class="text-gray-700"><?php echo trans('app.'.'outstanding'); ?> </span>
		...
		<section class="panel panel-info">
			<div class="panel-body">
				<div class="clear text-sm">
					<span class="text-gray-700"><?php echo trans('app.'.'this_year'); ?> </span>
...
</div><?php /**PATH C:\xampp2\htdocs\NETIC360APP\Modules\Analytics\Providers/../Resources/views/_invoices/dashboard.blade.php ENDPATH**/ ?>