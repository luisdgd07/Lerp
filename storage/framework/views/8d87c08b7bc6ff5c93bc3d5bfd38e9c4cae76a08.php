                ...
                <tbody>
                    ...
                    <tr class="bg-white">
                        ...
                        <td class="px-6 py-4 text-sm leading-5 text-gray-500 border-b border-gray-200">
                            <a href="<?php echo e(route('projects.view',['project' => $task->project_id])); ?>" class="text-indigo-600"><?php echo e(str_limit($task->AsProject->name, 25)); ?></a>
                        </td>
...
</div><?php /**PATH C:\xampp2\htdocs\NETIC360APP\resources\views/livewire/task/index-table.blade.php ENDPATH**/ ?>