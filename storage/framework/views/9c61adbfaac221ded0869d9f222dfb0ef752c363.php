        ...
        <section class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <input type="text" name="website_name" class="form-control" value="<?php echo e(get_option('website_name')); ?>">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <input type="text" name="login_title" class="form-control" value="<?php echo e(get_option('login_title')); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group iconpicker-container col-lg-6">
                        ...
                        <input id="icon" name="site_icon" type="text" value="<?php echo e(get_option('site_icon')); ?>" class="form-control icp icp-auto iconpicker-element iconpicker-input"
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <select name="htmleditor" class="form-control">
                            <option value="easyMDE" <?php echo e(get_option('htmleditor') == 'easyMDE' ? ' selected' : ''); ?>>EasyMDE Editor (Markdown)</option>
                            <option value="summernoteEditor" <?php echo e(get_option('htmleditor') == 'summernoteEditor' ? ' selected' : ''); ?>>Summernote (HTML Editor)</option>
                            <option value="markdownEditor" <?php echo e(get_option('htmleditor') == 'markdownEditor' ? ' selected' : ''); ?>>Bootstrap Markdown Editor</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <select name="widget_bg" class="form-control">
                            <option value="success" <?php echo e($widget_bg == 'success' ? ' selected' : ''); ?>>Success</option>
                            <option value="info" <?php echo e($widget_bg == 'info' ? ' selected' : ''); ?>>Info</option>
                            <option value="danger" <?php echo e($widget_bg == 'danger' ? ' selected' : ''); ?>>Danger</option>
                            <option value="warning" <?php echo e($widget_bg == 'warning' ? ' selected' : ''); ?>>Warning</option>
                            <option value="dark" <?php echo e($widget_bg == 'dark' ? ' selected' : ''); ?>>Dark</option>
                            <option value="primary" <?php echo e($widget_bg == 'primary' ? ' selected' : ''); ?>>Primary</option>
                            <option value="dracula" <?php echo e($widget_bg == 'dracula' ? ' selected' : ''); ?>>Dracula</option>
                        </select>
                    </div>
                </div>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Text::class, ['value' => ''.e(get_option('site_author')).'','name' => 'site_author']); ?>
<?php $component->withName('inputs.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['for' => 'site_author']); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php if (isset($component)) { $__componentOriginal942cbedc8524995abeccadc00a91f89c8cb356bd = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Text::class, ['value' => ''.e(get_option('site_keywords')).'','name' => 'site_keywords']); ?>
<?php $component->withName('inputs.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['for' => 'site_keywords']); ?>
<?php if (isset($__componentOriginal942cbedc8524995abeccadc00a91f89c8cb356bd)): ?>
<?php $component = $__componentOriginal942cbedc8524995abeccadc00a91f89c8cb356bd; ?>
<?php unset($__componentOriginal942cbedc8524995abeccadc00a91f89c8cb356bd); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <?php if (isset($component)) { $__componentOriginal942cbedc8524995abeccadc00a91f89c8cb356bd = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Inputs\Text::class, ['value' => ''.e(get_option('site_desc')).'','name' => 'site_desc']); ?>
<?php $component->withName('inputs.text'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['for' => 'site_desc']); ?>
<?php if (isset($__componentOriginal942cbedc8524995abeccadc00a91f89c8cb356bd)): ?>
<?php $component = $__componentOriginal942cbedc8524995abeccadc00a91f89c8cb356bd; ?>
<?php unset($__componentOriginal942cbedc8524995abeccadc00a91f89c8cb356bd); ?>
<?php endif; ?>
...
<?php echo $__env->make('stacks.js.iconpicker', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp2\htdocs\NETIC360APP\Modules\Settings\Providers/../Resources/views/sections/theme.blade.php ENDPATH**/ ?>