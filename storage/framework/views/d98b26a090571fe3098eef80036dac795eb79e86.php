...
} elseif ($_instance->childHasBeenRendered('OtbkuDr')) {
    $componentId = $_instance->getRenderedChildComponentId('OtbkuDr');
    $componentTag = $_instance->getRenderedChildComponentTagName('OtbkuDr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OtbkuDr');
} else {
    $response = \Livewire\Livewire::mount('task.index-table');
    $html = $response->html();
    $_instance->logRenderedChild('OtbkuDr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp2\htdocs\NETIC360APP\Modules\Tasks\Providers/../Resources/views/index.blade.php ENDPATH**/ ?>