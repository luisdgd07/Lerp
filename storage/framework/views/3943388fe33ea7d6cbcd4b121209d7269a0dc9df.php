...
$ext = substr($favicon, -4);?>
    ...
    <link rel="stylesheet" href="<?php echo e(mix('css/theme.css')); ?>" type="text/css" />
    <link rel="stylesheet" href="<?php echo e(getAsset('plugins/toastr/toastr.min.css')); ?>">

    <link rel="stylesheet" href="<?php echo e(mix('css/login.css')); ?>" type="text/css" />
...
</html><?php /**PATH C:\xampp2\htdocs\NETIC360APP\resources\views/layouts/auth.blade.php ENDPATH**/ ?>