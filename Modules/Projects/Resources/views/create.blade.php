        ...
        <section class="vbox">
            <header class="px-2 pb-2 bg-white border-b border-gray-400 panel-heading">
                <div class="flex justify-between text-gray-500">
                    ...
                    <div>
                        <a href="{{ route('projects.default.config') }}" class="btn {{themeButton()}} pull-right" data-toggle="ajaxModal" data-rel="tooltip"
            ...
            <section class="scrollable wrapper bg">
                <div class="row">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group m-b">
                                        ...
                                        <span class="input-group-addon">
                                            @can('clients_create')
                                            <a href="{{  route('clients.create')  }}" data-toggle="ajaxModal" title="@langapp('new_company')  "
                                                data-placement="bottom">@icon('solid/user-tie') @langapp('new_client') </a>
                                            @endcan
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div id="hourly_rate" class="display-none">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control money" name="hourly_rate" value="{{  get_option('hourly_rate')  }}">
                                    </div>
                                </div>
                    ...
                    <div class="col-md-5">
                        <section class="panel panel-default">
                            <header class="panel-heading"><i class="fas fa-cogs"></i> @langapp('settings') </header>
                            <div class="panel-body">
