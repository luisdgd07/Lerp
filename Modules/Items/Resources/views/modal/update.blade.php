    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <input type="text" class="form-control money" value="{{ formatDecimal($item->quantity) }}" name="quantity">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <input type="text" class="form-control money" value="{{ formatDecimal($item->unit_cost) }}" name="unit_cost">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <input type="text" class="form-control money" value="{{ formatDecimal($item->discount) }}" name="discount">
                </div>
            </div>
