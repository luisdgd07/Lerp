    ...
    <section class="panel panel-default bg-white m-t-sm b-r-xs">
      ...
      <div class="wizard">
        ...
        <div class="step-content clearfix">
          @if(!is_null(session('message')) && session('message')['status'])
          ...
          <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="config-form tabs-wrap">
            ...
            <div class="form-group {{ $errors->has('database_hostname') ? ' has-error ' : '' }}">
              ...
              <input type="text" class="form-control" name="database_hostname" id="database_hostname" value="{{ old('database_hostname') }}" placeholder="localhost or 127.0.0.1" required>
            ...
            <div class="form-group {{ $errors->has('database_password') ? ' has-error ' : '' }}">
              ...
              <input type="password" class="form-control" name="database_password" id="database_password" value="{{ old('database_password') }}" placeholder="Database Password">
