    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-8">
                        <select name="client_id" class="form-control m-b select2-option">
                            <option value="0" {{ $expense->client_id > 0 ? '' : 'selected' }}>None</option>
            ...
            <div class="form-group">
                ...
                <div class="col-lg-8">
                    <div class="input-group">
                        <input class="datepicker-input form-control" size="16" type="text" value="{{  datePickerFormat($expense->expense_date)  }}" name="expense_date"
